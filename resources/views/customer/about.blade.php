    ...
    <section class="abtSecHolder container pt-xl-24 pb-xl-12 pt-lg-20 pb-lg-10 pt-md-16 pb-md-8 pt-10 pb-5">
        <div class="row">
            <div class="col-12 col-lg-6 pt-xl-12 pt-lg-8">
                ...
                <p style="text-align: left" class="pr-xl-16 pr-lg-10 mb-lg-0 mb-6">We are providing a plug-n-play Intelligent Green House to the people, who are passionate about growing the Ornamental into their lawns but they are unable to do that because ornamental plants require some specific environmental constraints. </p>
                <p style="text-align: left" class="pr-xl-16 pr-lg-10 mb-lg-0 mb-6">By Installing this Plug-n-Play green house, People will be able to grow any plant from any region of the World. The Intelligent Green House will provide the suitable temperature, soil-moisture, humidity, and light to the plant that is required for that plant. </p>
                <p style="text-align: left" class="pr-xl-16 pr-lg-10 mb-lg-0 mb-6">For this, the user just needs to enter the – soil-moisture, humidity, light, and temperature – parameters and then the user will be free from any difficulty.</p>
            </div>
            <div class="col-12 col-lg-6">
                <img src="{{ asset('assets_1/images/GreenMonitor.png') }}" alt="image description" class="img-fluid">
            </div>
        </div>
    </section>
            ...
            <div class="col-12">
                ...
                <ul class="progressCounter list-unstyled mb-2 d-flex flex-wrap text-capitalize text-center">
                    <li class="mb-md-0 mb-3">
                        <strong class="d-block fwEbold counter mb-2">2</strong>
                        <strong class="d-block text-uppercase txtWrap">Happy Clients</strong>
                    </li>
                    <li class="mb-md-0 mb-3">
                        <strong class="d-block fwEbold counter mb-2">1</strong>
                        <strong class="d-block text-uppercase txtWrap">completed project</strong>
                    </li>
                    <li class="mb-md-0 mb-3">
                        <strong class="d-block fwEbold counter mb-2">5</strong>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-6 mb-lg-0 mb-6">
                    <img src="{{ asset('assets_1/images/img81.png') }}" alt="image description" class="img-fluid">
                </div>
                <div class="col-12 col-lg-6">
