...
<div class="col-lg-12 col-lg-offset-1">
    <h1><i class="fa fa-users"></i> Customer Management <a href="/roles" class="btn btn-default pull-right">Roles</a>
    ...
    <a href="{{ route('users.create') }}" class="btn btn-success submit-btn">+ Add Customer</a>
