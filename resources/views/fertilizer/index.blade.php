...
<div class="card">
    ...
    <div class="card-header">
       ...
       <a href="fertilizer_form/0" class="btn btn-success" style="float: right">+ Add New Fertilizer</a>
    ...
    "columns":[
        ...
        {data: 'action', name: 'action', orderable: false, searchable: false},
         ...
         <script>
          ...
          var url = "{{url('fertilizer_delete')}}/"+delete_id;
          Swal.fire({
							  title: 'Are you sure?',
